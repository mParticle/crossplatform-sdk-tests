...
@property (readonly) MPMTBoolean * _Nullable modifiedBatch __attribute__((swift_name("modifiedBatch")));
...
- (instancetype)initWithTimeStamp:(MPMTLong * _Nullable)timeStamp stateInfo:(MPMTModelsStateInfoMessage * _Nullable)stateInfo id:(NSString * _Nullable)id sessionId:(NSString * _Nullable)sessionId sessionStartTimestamp:(MPMTLong * _Nullable)sessionStartTimestamp location:(MPMTModelsLocationMessage * _Nullable)location dataConnection:(NSString * _Nullable)dataConnection attributes:(NSDictionary<NSString *, id> * _Nullable)attributes eventFlags:(NSDictionary<NSString *, id> * _Nullable)eventFlags eventStartTime:(MPMTLong * _Nullable)eventStartTime eventCount:(MPMTInt * _Nullable)eventCount __attribute__((swift_name("init(timeStamp:stateInfo:id:sessionId:sessionStartTimestamp:location:dataConnection:attributes:eventFlags:eventStartTime:eventCount:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
@property MPMTInt * _Nullable eventCount __attribute__((swift_name("eventCount")));
@property NSDictionary<NSString *, id> * _Nullable eventFlags __attribute__((swift_name("eventFlags")));
@property MPMTLong * _Nullable eventStartTime __attribute__((swift_name("eventStartTime")));
@property NSString * _Nullable id __attribute__((swift_name("id")));
