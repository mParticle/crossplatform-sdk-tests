...
actual open class Platforms {
    ...
    actual fun getDatabaseContents(tables: List<String>?): Map<String, Any> = getDatabaseContents(
        MParticleDBManager(mContext).getDatabase())
    ...
    actual fun getDatabaseSchema(tables: List<String>?): Map<String, Any> = getDatabaseSchema(
        MParticleDBManager(mContext).getDatabase())
